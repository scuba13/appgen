...
Quando o usuario digitar `appgen`, `$appgen`, selecionar a skill AppGen pelo menu de skills ou usar uma entrada slash equivalente da interface, inicie ou retome o fluxo AppGen.
