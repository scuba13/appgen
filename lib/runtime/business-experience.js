...
export const STEP_EXPERIENCE = {
  brief: {
    ...
    action: 'Responder perguntas sobre objetivo, usuarios, regras e aceite.',
  },
  standards: {
...
\`\`\`bash
appgen acceptance --feedback-type=business --feedback="Descreva a regra ou fluxo que precisa mudar."
appgen acceptance --feedback-type=technical --feedback="Descreva o comportamento que falhou."
appgen acceptance --feedback-type=environment --feedback="Descreva o bloqueio para abrir ou testar a app."
\`\`\`
